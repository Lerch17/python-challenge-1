        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    item_ordered = menu_items[menu_selection]
...
for customer_order in order:
    ...
    print(f"{item_name}{item_space}| ${price}{price_space}| {quantity}{quantity_space}")
    

# 11. Calculate the cost of the order using list comprehension
# Multiply the price by quantity for each item in the order list, then sum()
# and print the prices.
Final_cost = sum(customer_order["Price"] * customer_order["Quantity"] for customer_order in order)
print(f"Your total comes out to {Final_cost:.2f}")